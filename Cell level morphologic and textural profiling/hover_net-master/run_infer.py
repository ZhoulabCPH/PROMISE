...
Options:
  ...
  --gpu=<id>                  GPU list. [default: 0]
  --nr_types=<n>              Number of nuclei types to predict. [default: 0]
  --type_info_path=<path>     Path to a json defining mapping between type id, type name, 
                              and expected overlaid color. [default: '']
...
Commands:
  tile  Run inference on tiles
  wsi   Run inference on whole slide images
"""
import torch
import logging
import os
...
if __name__ == '__main__':
    ...
    test_argv = [
        ...
        "tile",
        "--input_dir=./Inputdir",
        "--output_dir=./Out_PutDir",
        "--mem_usage=0.3",
        "--draw_dot"
    ]
    # 使用 docopt 解析模拟参数
    args = docopt(__doc__, argv=test_argv, help=True, options_first=True, version='HoVer-Net Pytorch Inference v1.0')
    ...
    sub_args = docopt(tile_cli, argv=sub_cmd_args, help=True)
    ...
    if types=='Seg':
        ...
        args['model_path']='./MyModels/hovernet_fast_pannuke_type_tf2pytorch'
        args['nr_types']=0
        ...
        args['model_path']='./MyModels/hovernet_original_consep_type_tf2pytorch'
        args['nr_types']=5
        args['type_info_path'] ='./type_info.json'
