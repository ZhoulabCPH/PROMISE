...
class SCLCDataset(Dataset):
    def __init__(self,df,feature,name,clincials,Protein,PreProtein,args,ratio=1):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            index_Protein=None
        PreProtein = torch.tensor(np.array(self.PreProtein[self.PreProtein['Patient']==np.int64(patient_name)].values[:,1:],dtype=np.float32))
        ...
        r['PreProtein']=PreProtein
        return r

class SCLCDataset_Val(Dataset):
    def __init__(self,df,feature,name,clincials,Protein,PreProtein,args):
...
tensor_list = [
     'name1','feature','OS','DFS','OSState','DFSState','Protein','PreProtein'
]
...
tensor_list = ['name1','feature','OS','DFS','OSState','DFSState','Protein','PreProtein']
